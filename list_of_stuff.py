...
class products:
    ...
    def validation_inventory(self):  # noi stands for number of inventory
        lst = []
        with open('goods.csv', 'r') as file:
            reader = csv.DictReader(file)
            for i in reader:
                # print(i['number_of_inventory'])
                # print(int(i['number_of_inventory']))
...
# b.saving()
# c = products("Ofogh","497634215","76000","adidas","bag","1","2040.1.13")
# c.saving()
